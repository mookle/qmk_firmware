...
[_COLEMAK] = LAYOUT_planck_grid(
    ...
    MOD_LSFT, KC_Z,    KC_X,    KC_C,    KC_D,    KC_V,    KC_K,    KC_H,    KC_COMM, KC_DOT,  KC_SLSH, MOD_RSFT,
    KC_LCTL,  KC_DEL,  KC_LALT, KC_LGUI, LOWER,   KC_SPC,  KC_SPC,  RAISE,   KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT
),
 ...
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * |  F7  |  F8  |  F9  |  F10 |  F11 |  F12 |   0  |      | Play | Vol- | Vol+ | Next |
 * `-----------------------------------------------------------------------------------'
 */
[_LOWER] = LAYOUT_planck_grid(
    KC_GRV,  KC_PIPE, _______, _______, _______, _______, KC_7, KC_8,    KC_9,    KC_LPRN, KC_RPRN, _______,
    _______, _______, _______, _______, _______, _______, KC_4, KC_5,    KC_6,    KC_PLUS, KC_MINS, KC_EQL,
    KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F6,   KC_1, KC_2,    KC_3,    KC_ASTR, _______, _______,
    KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,  KC_F12,   KC_0, _______, KC_MPLY, KC_VOLD, KC_VOLU, KC_MNXT
),
